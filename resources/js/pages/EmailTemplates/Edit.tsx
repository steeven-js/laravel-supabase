...
export default function EmailTemplatesEdit({ emailTemplate, categories, subCategories }: Props) {
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        },
        {
            ...
            href: `/email-templates/${emailTemplate.id}/edit`,
        },
    ];
    ...
    const { data, setData, patch, processing, errors } = useForm({
        ...
        sub_category: emailTemplate.sub_category,
    ...
    // Initialiser les sous-catégories disponibles au chargement
    useEffect(() => {
        if (data.category) {
            const availableSubs = subCategoryMapping[data.category] || [];
