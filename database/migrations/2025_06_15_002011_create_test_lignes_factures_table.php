...
return new class extends Migration
{
    ...
    {
        Schema::create('test_lignes_factures', function (Blueprint $table) {
            $table->id();
            $table->foreignId('facture_id')->constrained('test_factures')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('test_lignes_factures');
    }
};
