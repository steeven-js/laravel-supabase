...
return new class extends Migration
{
    ...
    {
        Schema::create('test_factures', function (Blueprint $table) {
            $table->id();
            $table->string('numero_facture')->unique();
            $table->foreignId('devis_id')->nullable()->constrained('test_devis')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('test_factures');
    }
};
