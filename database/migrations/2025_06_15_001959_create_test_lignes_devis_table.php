...
return new class extends Migration
{
    ...
    {
        Schema::create('test_lignes_devis', function (Blueprint $table) {
            $table->id();
            $table->foreignId('devis_id')->constrained('test_devis')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('test_lignes_devis');
    }
};
